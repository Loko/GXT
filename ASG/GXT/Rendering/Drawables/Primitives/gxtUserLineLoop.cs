...
{
    public class gxtUserLineLoop : gxtIDrawable
    {
        ...
        */
        ...
        public gxtUserLineLoop()
        {
            gxtDebug.Assert(gxtRoot.SingletonIsInitialized);
        }

        public gxtUserLineLoop(gxtIMaterial material)
        {
            gxtDebug.Assert(gxtRoot.SingletonIsInitialized);
            this.material = material;
        }

        public gxtUserLineLoop(Vector2[] verts, gxtIMaterial material, bool setDefaultIndices = true)
        {
            gxtDebug.Assert(gxtRoot.SingletonIsInitialized);
        ...
        public gxtUserLineLoop(Vector2[] verts, int[] indices)
        {
            gxtDebug.Assert(gxtRoot.SingletonIsInitialized);
            gxtDebug.Assert(verts != null && verts.Length >= 2);
        ...
        public gxtUserLineLoop(Vector2[] verts, int[] indices, gxtIMaterial material)
        {
            gxtDebug.Assert(gxtRoot.SingletonIsInitialized);
            gxtDebug.Assert(verts != null && verts.Length >= 2);
            gxtDebug.Assert(indices != null && indices.Length >= 2);
