...
{
    // a texture animated mesh
    // will work like a spritesheet
    // keeps a collection of texture coordinates that can be manipulated by an iterator type wrapper
    public class gxtDynamicMesh : gxtIMesh
    {
        ...
        public gxtDynamicMesh()
        {

        }

        public gxtDynamicMesh(Vector2[] verts, bool setDefaultIndices = true)
        {
        ...
        public gxtDynamicMesh(Vector2[] verts, int[] indices)
        {
            gxtDebug.Assert(gxtRoot.SingletonIsInitialized);
